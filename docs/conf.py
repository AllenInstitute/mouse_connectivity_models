...
# -*- coding: utf-8 -*-
#
# voxel_model documentation build configuration file, created by
...
release = voxel_model.__version__
...
htmlhelp_basename = 'voxel_modeldoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'voxel_model.tex',
     u'voxel_model Documentation',
...
def run_apidoc(_):
    ...
    module = os.path.join(cur_dir,"..","voxel_model")
