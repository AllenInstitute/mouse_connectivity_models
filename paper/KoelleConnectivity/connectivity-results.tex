...
\begin{figure}[H]
\subfloat[]{
    \includegraphics[width=1.\textwidth]{../../analyses/paper/figures/visp_mo_0615.png} 
    }
    \newline
 \subfloat[]{
    \includegraphics[width=1.\textwidth]{../../analyses/paper/figures/heirarchical.png}
    }
    \label{fig:data}
\end{figure}
\newpage
...
\begin{figure}[H]
\begin{tabular}[t]{c}
\subfloat[]{\includegraphics[width = 1. \textwidth]{../../paper/figures/H_wt_0617.png}}
\\
%\subfloat[]{\includegraphics[width = 1.5in]{figs/figsforpres/test_train.png}} &
\subfloat[]{\includegraphics[width = .4\textwidth]{../../paper/figures/W_wt_0617.png}}
\end{tabular}
\end{figure}
