...
The key step therefore is finding a suitable function $g$ with which to weight the positional and (Cre,leaf) information.
...
\subfloat[]{
   ...
   \ref{fig:expected_loss} Distribution of projection errors against centroid distance and cre-distance in Isocortex.
    ...
    Projection distance is $ \|y_{\mathcal T}(i) - y_{\mathcal T}(i')\|_2$, Cre-distance is  $ \| \bar y_{\mathcal T,s,v} -  \bar y_{\mathcal T,s,v}(i)\| )\|_2$, and centroid-distance is $ \|c(i') - c(i)\|_2$.
    }
   \end{figure}
...
It should be considered an alternative method to the classic weighted kernel method \citep{Cai2001-hk, Salha_undated-ev}.
...
\label{supp_sec:cell_type_specificity}
