...
Thus, this paper introduces a class-specific statistical model to deal with the diverse set of \textbf{Cre-lines} described in \citet{Harris2019-mr}, and expands this model to the entire mouse brain.
%Since the set of cells targeted by a particular combination of transgene promoter and transgenic mouse line
%In cortex a large number of transgenic lines were chosen for their laminar specific expression.
