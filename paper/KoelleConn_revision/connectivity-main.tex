...
{Samson Koelle \affil{1,2}, Jennifer D Whitesell \affil{1}, Karla E Hirokawa \affil{1},  Hongkui Zeng\affil{1}, Marina Meila\affil{2}, Julie A Harris\affil{1}, Stefan Mihalas\affil{1}}
...
Inspired by how this complexity arises from a relatively parsimonious set of genetic information during development, we also show that the wild type connectivity matrix can be factored using a sparse set of factors, and analyze the informativeness of this underlying latent structure.
