...
The main result of this paper is the collection of cell-type specific connectivity estimates from the Allen Mouse Connectivity Atlas (MCA) experiments.
...
Since source and cell-type combinations which project similarly are an important characteristic of the cognitive network structure, we investigate the presence of several biological processes within our connectivity estimates.
